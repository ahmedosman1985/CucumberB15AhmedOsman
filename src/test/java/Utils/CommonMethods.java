...
public class CommonMethods extends PageInitializer {
    ...
    public static void openBrowserAndLaunchApplication() {
        ...
        initializePageObjects(); //This will initialize all the pages we have in our page
                                 //PageIntializer class along with the launching of application
        // To configure the File and pattern it has
        DOMConfigurator.configure("log4j.xml");
        Log.startTestCase("Thia ia thw beginning of my Test Case");
        Log.info("My test case is executin right now");
    ...
    public static byte[] takeScreenshot(String imageName){
        ...
        //This casts the webDriver instance 'driver' to TalkScreenshot Interface
        TakesScreenshot ts = (TakesScreenshot) driver;

        //This captures the screenshot and stores it as byte array
        byte [] picBytes = ts.getScreenshotAs(OutputType.BYTES);

        //This captures the sceenshot and stores it as a file in the sourceFile variable
