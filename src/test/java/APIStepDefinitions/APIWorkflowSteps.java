...
public class APIWorkflowSteps {
    ...
    public void a_request_is_prepared_to_create_an_employee() {
        request = given().
                //below will be replaced by constants
    ...
    public void the_status_code_for_creating_an_employee_is(Integer int1) {
        //arguement/value is coming from feature file
    ...
    public void the_employee_id_employee_employee_id_is_stored_as_a_global_variable_to_be_used_for_other_calls(String string) {
